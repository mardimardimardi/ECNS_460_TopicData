...
combined_yearly <- healthrank_to_yearly(health_ranking)
...
ggplot() +
  ...
  geom_point(data = or_yearly, aes(x = year, y = log(combined_overdose_deaths), color = "Oregon"), size = 1) +
  geom_point(data = ca_yearly, aes(x = year, y = log(combined_overdose_deaths), color = "California"), size = 1) +
  geom_point(data = wa_yearly, aes(x = year, y = log(combined_overdose_deaths), color = "Washington"), size = 1) +
...
We used a difference-in-difference regression with fixed effects to investigate the impact of drug decriminalization in Oregon counties compared to other states.
