...
### Topic:
The effect of drug decriminalization on overdose deaths and well-being.
...
The Well-Being Ranks, Overdose Mortality by County contain county fips codes, county names and year in relation. 
The Overdose by Drug has a relationship of total non-fatal drug overdoses in each state. 
